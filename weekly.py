...
DEFAULT_CUTOFF_DAYS = int(os.getenv("CUTOFF_DAYS", "7"))
API_KEY = os.getenv("INTELX_API_KEY", "")
BASE_URL = os.getenv("INTELX_BASE_URL", "https://free.intelx.io")
DELAY = float(os.getenv("INTELX_DELAY", "1.0"))
...
def main() -> None:
    ...
    if not API_KEY or not BASE_URL:
        raise SystemExit("Stel INTELX_API_KEY en INTELX_BASE_URL in via .env of omgevingsvariabelen.")
